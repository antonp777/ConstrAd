...
from core.schemas.ScPayment import PaymentRead, PaymentCreate
...
async def get_payment_by_id(session: Annotated[AsyncSession, Depends(db_helper.session_getter)], payment_id: int):
...
async def get_payment_by_user_id(session: Annotated[AsyncSession, Depends(db_helper.session_getter)], user_id: int):
...
async def create_payment(session: Annotated[AsyncSession, Depends(db_helper.session_getter)], payment_create: PaymentCreate):
